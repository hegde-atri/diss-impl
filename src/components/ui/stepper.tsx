  ...
  ({ asChild = false, className, children, ...props }, ref) => {
    ...
    return (
      <button
        ref={ref}
        className={cn(
          "flex w-full flex-col items-center justify-center text-center gap-2 disabled:pointer-events-none disabled:opacity-50",
          className,
        )}
  ...
  ({ asChild = false, className, children, ...props }, ref) => {
    ...
    return (
      <div
        ref={ref}
        className={cn(
          "relative flex size-8 shrink-0 items-center justify-center rounded-full bg-muted text-xs font-medium text-muted-foreground data-[state=active]:bg-primary data-[state=completed]:bg-primary data-[state=active]:text-primary-foreground data-[state=completed]:text-primary-foreground mb-1",
          className,
        )}
        data-state={state}
        {...props}
      >
        {asChild ? (
          ...
          <>
            ...
            <CheckIcon
              className="absolute scale-0 opacity-0 transition-all group-data-[state=completed]/step:scale-100 group-data-[state=completed]/step:opacity-100 h-4 w-4"
              aria-hidden="true"
            />
            {isLoading && (
